...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        // viewBinding ativado no arquivo buil.gradle
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://lybueno.github.io/matches-simulator-api/")
    ...
    private void setMatchesRefresh() {
        //atualizar as partidas na ação swipe
...
//                    Log.i("SIMULATOR", "Ok. Matches number: " + matches.size());
